...
class Statics {
	...
	/*Electra signature namespace for custom XMP metadata*/
	public static function signNS()
	{
		return "http://w2.inf.unideb.hu/~maszatweb/signature/";
	}
	...
	public static function getObjFilename($type='tmp', $file_id='') {
		return tempnam(K_PATH_CACHE, '__tcpdf_'.$file_id.'_'.$type.'_'.md5(Statics::getRandomSeed()).'_');
	}

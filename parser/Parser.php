<?php
namespace tcpdf\parser;
use \tcpdf\filter\Filters;

//============================================================+
// Last Update : 2015-06-18
// Author      : Tibor Roskó - University of Debrecen
// -------------------------------------------------------------------
// File name   : 2016-03-27
// Version     : 1.0.16
// Begin       : 2011-05-23
...
class Parser {
	 ...
	 */
	private $cfg = array(
		//'die_for_errors' => false,//HAVE TO BE FALSE AS IN COMPONENT WAY USE EXCEPTIONS
...
// -----------------------------------------------------------------------------
	...
	public function __construct($data, $cfg=array()) {
		...
		// get length
		$this->pdflen = strlen($this->pdfdata);
	 ...
	 * @return Array containing pdf length, last startxref, xref and trailer data.
	 * @protected
	 * @since 1.0.000 (2011-05-24)
	 */
		...
		switch ($char) {
			...
			case ')': { // \x29 RIGHT PARENTHESIS
				...
				if ($char == '(') {
					...
					//$objval = substr($this->pdfdata, $offset, ($strpos - $offset - 1)); //don't leave final ')'
					$objval = substr($this->pdfdata, $offset, ($strpos - $offset));
					$offset = $strpos;
				}
				break;
			}
			...
			case ']': { // \x5D RIGHT SQUARE BRACKET
				...
				if ($char == '[') {
					...
					//array_pop($objval); //don't leave final ']'
				}
				break;
			}
	...
	public function Error($msg) {
		if (defined('K_TCPDF_THROW_EXCEPTION_ERROR') AND !K_TCPDF_THROW_EXCEPTION_ERROR) {
			die('<strong>Parser ERROR: </strong>'.$msg);
		} else {
